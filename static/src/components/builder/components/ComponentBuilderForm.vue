<template>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">Component Builder - {{selectedComponent.name}}</div>
                ...
                <div class="row"> 
                    <div class="col-md-12">                        
                       <div class= "row">
                        ...
                        <div class= "row">
                            <PreviewComponent class="col-md-12" :form = "formToPreview" :addLabel = "addLabel" :selectedComponent = "selectedComponent"></PreviewComponent>
                        </div>
                    </div>
                </div>            
            </div> 
...
export default { 
    ...
    data(){
        return {
            ...
            components,
            booleanValues,
            form: this.initializeForm(components[0]),
            addLabel: false
        }
    },
    components: {
